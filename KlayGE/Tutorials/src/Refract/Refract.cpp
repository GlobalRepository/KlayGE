...
void Refract::OnCreate()
{
	...
	checked_cast<RefractorRenderable&>(refractor_->FirstComponentOfType<RenderableComponent>()->BoundRenderable())
		.CompressedCubeMap(y_cube_map, c_cube_map);
