		...
		this->OnMainThreadUpdate().Connect([](SceneNode& node, float app_time, float elapsed_time)
			{
				...
				auto& inf_terrain_renderable =
					checked_cast<InfTerrainRenderable&>(node.FirstComponentOfType<RenderableComponent>()->BoundRenderable());
		...
		this->OnMainThreadUpdate().Connect([](SceneNode& node, float app_time, float elapsed_time)
			{
				...
				auto& hq_inf_terrain_renderable =
					checked_cast<HQTerrainRenderable&>(node.FirstComponentOfType<RenderableComponent>()->BoundRenderable());
